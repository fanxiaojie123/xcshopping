...
import cn.axy.xc.xcitemshowprovider.dao.Ornpricedao;
...
@Repository
public class Ornpricesolrimpl implements Ornpricedao {
    ...
    public List<Ornaments> ornprice(Skupricesolr skupricesolr) throws Exception {
        ...
        filterQuery.addFilterQuery("fq","oColor:"+ skupricesolr.getmColor());
        filterQuery.addFilterQuery("fq","oSize:"+ skupricesolr.getmSize());
        solrQuery.set("fl", "id,oPrice,oCount,mId");
        // 执行查询
