package cn.axy.xc.xcitemshowprovider.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                // 自行修改为自己的包路径cn.axy.xc.xcitemshowprovider.controller
                .apis(RequestHandlerSelectors.basePackage("cn.axy.xc.xcitemshowprovider.controller"))
