		...
		<div data-id="100002" class="prop-attrs">
			<div class="attr">
				...
				<div class="a-values">
					<div class="v-fold">
						<ul class="f-list">
							<li><a href="javascript:filter('price','0-99')">0-99</a></li>
							<li><a href="javascript:filter('price','100-199')">100-199</a></li>
							<li><a href="javascript:filter('price','200-299')">200-299</a></li>
							<li><a href="javascript:filter('price','300-399')">300-399</a></li>
							<li><a href="javascript:filter('price','400-499')">400-499</a></li>
							<li><a href="javascript:filter('price','500-*')">500以上</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<div id="filter">
	...
	<div class="fore1">
		...
		<div class="total">
			<span>共<strong>${productModels.size() }</strong>个商品
			</span>
		</div>
		<span class="clr"></span>
	</div>
...
<div id="plist" class="m plist-n7 plist-n8 prebuy">
	<ul class="list-h">
		...
		<li pid="${item.id}">
			<div class="lh-wrap">
				<div class="p-img">
					<a target="_blank" href="https://item.jd.com/100000287117.html">
						<img width="220" height="282" class="err-product" src="${item.mPicture}">
					</a>
				</div>
				<div class="p-name">
					<a target="_blank" href="#">${item.mName}</a>
				</div>
				<div class="p-name">
					<a target="_blank" href="#">${item.mPoints}</a>
				</div>
				<div class="p-name">
					<a target="_blank" href="#">${item.sName}</a>
				</div>
				<div class="p-price">
					<strong>￥<fmt:formatNumber value="${item.mPrice}" maxFractionDigits="2"/></strong><span id="p1269191543"></span>
				</div>
			</div>
		</li>
		</c:forEach>
