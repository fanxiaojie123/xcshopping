...
import cn.axy.xc.xcitemshowprovider.dao.Clopricedao;
...
@Service
public class Clopricesolrimpl implements Clopricedao {
    ...
    public List<Clothing> colprice(Skupricesolr skupricesolr) throws Exception {
        ...
        filterQuery.addFilterQuery("fq","cColor:"+ skupricesolr.getmColor());
        filterQuery.addFilterQuery("fq","cSize:"+ skupricesolr.getmSize());
        solrQuery.set("fl", "id,aPrice,cCount,mId");
        // 执行查询
